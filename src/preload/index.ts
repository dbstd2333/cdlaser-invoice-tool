...
const api = {
  ...
  catalog: {
    ...
    initialImportConfirm: (token: string) => invoke<{ createdCount: number; newProductCount: number; newPriceVariantCount: number }>(IPC_CHANNELS.catalog.initialImportConfirm, token),
    ...
    dailyImportConfirm: (token: string) => invoke<{ createdCount: number; newProductCount: number; newPriceVariantCount: number }>(IPC_CHANNELS.catalog.dailyImportConfirm, token),
