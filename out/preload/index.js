...
electron.contextBridge.exposeInMainWorld("api", {
	...
	catalog: {
		...
		toggleProductStatus: (id) => invoke(IPC_CHANNELS.catalog.toggleProductStatus, id),
		createPriceVersion: (params) => invoke(IPC_CHANNELS.catalog.createPriceVersion, params),
		togglePriceVersionStatus: (id) => invoke(IPC_CHANNELS.catalog.togglePriceVersionStatus, id),
